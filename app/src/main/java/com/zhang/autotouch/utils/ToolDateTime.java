...
public class ToolDateTime {
	 ...
	 * @return
	 */
	public static String formatMidTime(long midTime) {
//		long day = midTime / (60 * 60 * 24);
//		long hour = (midTime / (60 * 60) - day * 24);
//		long min = ((midTime / 60) - day * 24 * 60 - hour * 60);
//		long s = (midTime - day*24*60*60 - hour*60*60 - min*60);

//		long m = midTime / 1000 / 60;
//		long s = (midTime -(m * 1000 * 60))  / 1000;
		long s = midTime / 1000;
		long ms = midTime - (s * 1000);
		long m = s / 60;
		s = s - m * 60;
	...
	public static boolean compareDate(Date target1, Date target2) {
		...
		try {
			...
			Log.e("time", "比较失败，原因：" + e1.getMessage());
		}
		return flag;
	}
